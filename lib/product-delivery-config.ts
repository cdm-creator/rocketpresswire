...
export const PRODUCT_DELIVERY_CONFIG = [
    ...
    {
        canonicalName: PRODUCT_NAME_MAP.investing_com,
        slug: "investing_com",
        aliases: ["Investing.com", "investing_com", "investing-com"],
        stripePriceIds: [PRODUCT_PRICE_MAP.investing_com],
        thriveCartProductIds: [],
        deliveryText: "5 Business Days",
        expectedDays: 5,
    },
    {
        canonicalName: PRODUCT_NAME_MAP.streetinsider,
        slug: "streetinsider",
        aliases: ["StreetInsider", "Street Insider", "streetinsider"],
        stripePriceIds: [PRODUCT_PRICE_MAP.streetinsider],
        thriveCartProductIds: [],
        deliveryText: "5 Business Days",
        expectedDays: 5,
    },
    {
        canonicalName: PRODUCT_NAME_MAP.digital_journal,
        slug: "digital_journal",
        aliases: ["Digital Journal", "digital_journal", "digital-journal"],
        stripePriceIds: [PRODUCT_PRICE_MAP.digital_journal],
        thriveCartProductIds: [],
        deliveryText: "5 Business Days",
        expectedDays: 5,
    },
    {
        canonicalName: PRODUCT_NAME_MAP.usa_wire,
        slug: "usa_wire",
        aliases: ["USA Wire", "usa_wire", "usa-wire"],
        stripePriceIds: [PRODUCT_PRICE_MAP.usa_wire],
        thriveCartProductIds: [],
        deliveryText: "5 Business Days",
        expectedDays: 5,
    },
    {
        canonicalName: PRODUCT_NAME_MAP.ny_weekly,
        slug: "ny_weekly",
        aliases: ["NY Weekly", "ny_weekly", "ny-weekly"],
        stripePriceIds: [PRODUCT_PRICE_MAP.ny_weekly],
        thriveCartProductIds: [],
        deliveryText: "5 Business Days",
        expectedDays: 5,
    },
    {
        canonicalName: PRODUCT_NAME_MAP.london_daily_news,
        slug: "london_daily_news",
        aliases: ["London Daily News", "london_daily_news", "london-daily-news"],
        stripePriceIds: [PRODUCT_PRICE_MAP.london_daily_news],
        thriveCartProductIds: [],
        deliveryText: "5 Business Days",
        expectedDays: 5,
    },
